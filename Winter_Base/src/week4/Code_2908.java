...
public class Code_2908 {
	...
	public static void main(String[] args) {
	    ...
	    String[] copyB =new String[b.length];
	    ...
	    int[] numA = Arrays.asList(copyA).stream().mapToInt(Integer::parseInt).toArray();
	    int[] numB = Arrays.asList(copyB).stream().mapToInt(Integer::parseInt).toArray();
	    int[] max= new int[10];
